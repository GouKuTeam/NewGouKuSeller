...
@implementation TiXianCompleteView
...
- (instancetype)initWithFrame:(CGRect)frame{
    ...
    if (self) {
        ...
        [self.imgStatus2 setImage:[UIImage imageNamed:@"blue_dot"]];
        ...
        [self.imgStatus3 setImage:[UIImage imageNamed:@"select"]];
...
//        [self.lab_2 setText:@"2017-01-02 08:00:00"];
        ...
        [self.lab_3 setTextColor:[UIColor colorWithHexString:@"#616161"]];
        self.lab_3.font = [UIFont fontWithName:@"PingFang-SC-Regular" size:16];
...
//        [self.lab_4 setText:@"预计2018-01-02前打款   "];
        ...
        [self.lab_5 setTextColor:[UIColor colorWithHexString:@"#000000"]];
        [self.lab_5 setFont:[UIFont systemFontOfSize:18]];
